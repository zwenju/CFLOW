function [L2, H1] =  FEM_calculate_parabolic_L2_H1_with_exact_sol (Mesh, t)
global fespace
...
for iElement = 1 : Mesh.ElementNum
    ...
    fespace_reference_2_physical_transform_1d(t2)
    ...
    %% exact solution 
    exact_value    = user_parabolic_exact_solution_1d    (fespace.phy_quad_pts, t, w);
    exact_value_dx = user_parabolic_exact_solution_dx_1d (fespace.phy_quad_pts, t, w);
